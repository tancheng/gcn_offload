...
int opt_count = 0;
int global_start = 0;
void ARENA_kernel0(int start, int end, int param, bool require_data, int length) {
...
void ARENA_kernel0_accum(int start, int end, int param, bool require_data, int length) {
  ++opt_count;
...
int k_dim;
void ARENA_kernel1(int start, int end, int param, bool require_data, int length) {
  cur_layer = 1;
...
void ARENA_kernel1_accum(int start, int end, int param, bool require_data, int length) {
  ++opt_count;
